...
function _makeQueryBuilderByFilter(filter, skip, limit, startDate, endDate, searchText, order) {
  ...
  if (searchText) {
    queryBuilder.where(function() {
      this.orWhere('templateCustomerMessageContent', 'like', `%${searchText}%`)
      .orWhere('templateCustomerMessageTitle', 'like', `%${searchText}%`)
    })
  } else {
    if(filterData.templateCustomerMessageContent){
      queryBuilder.where('templateCustomerMessageContent', 'like', `%${filterData.templateCustomerMessageContent}%`)
      delete filterData.templateCustomerMessageContent;
    }

    if(filterData.templateCustomerMessageTitle){
      queryBuilder.where('templateCustomerMessageTitle', 'like', `%${filterData.templateCustomerMessageTitle}%`)
      delete filterData.templateCustomerMessageTitle;
    }
  }
