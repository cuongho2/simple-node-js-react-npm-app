...
module.exports = [
  ...
  { method: 'POST', path: '/PaymentDepositTransaction/addRewardPointForUser', config: PaymentDepositTransaction.addRewardPointForUser },
  { method: 'POST', path: '/PaymentDepositTransaction/approveDepositTransaction', config: PaymentDepositTransaction.approveDepositTransaction },
  { method: 'POST', path: '/PaymentDepositTransaction/denyDepositTransaction', config: PaymentDepositTransaction.denyDepositTransaction },
